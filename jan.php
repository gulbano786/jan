...
array(
"<name>, Kya P0ST Dali Hy Main 2ho Dew0na Bangya....😝",
"link download Karni Hy <name> ?",
"Kamina Botter... , Shahid Sd Ka BOT Use Kya kro <name> ...🌻",
"SORRY <name> T3RI WALI S3 ACHA ZUKU KI B3TI H3",
"5 Woyat Namaz PaRo ... <name>",
)),
...
array(
"<name>, Bot By http://multibot2.ga",
"kuch kuch hota he, <name> tm ni smjho gy",
"Good Morning <name>",
"Dp share krdo :* ...",
...
array(
"Just Now Pe Aya Kro <name>",
"JANU ADD CLOSE",
"LIKE CMNT BACK , WRNA UNFRND, ",
"<name> Papii , dO Zra ",
"G <me> LIKE BCK DO, nito dafa <name>",
)),
...
"2mse Acha 2ho MeRa Wola Hy <name>",
"Dorr... Dor... Dor... Likers <me> Worning",
)),
...
array(
"Tum ben gia... nahi jae <name> janu apka",
"hehehehhe...",
"Ye <me> Ka Bot He <name> Deklo",
)),
...
array(
"<me> Ka Bot Lagalo <name>",
"swag se karenge <name> swagat",
"<name> Tu ClOse he dil k :* ",
"Assalam O AlAIKUM <name> KO Jwb Do,",
"Tera Hoke RaHen Ge <name> Baby doll tu sone dii",
"like comment back... now <name>",
)),
...
array(
"zal mat <name> Bara Bar Kar",
"Ab Ham Dono Dost Huye ♄1�7",
"Fb me Ham Donoki Dosti Khub Zamegi <name>",
)),
);

$AbdulRehmanNormal=array(
"Ahm ahm <me> ka bot",
"Mera Cmnt Oulta Hy <name>",
"Coba liat nih sama kan.. <name> gitu loh",
"gooD AfteR Noon <name>",
"Ham KaLe Hy 2ho Kya Huya Dilwole Hy  <name> Hihihihi...",
"Speer Check Kar <name>",
"G NEW DAL POST <name> ah..Wkwkwkwk",
"BABY FEEL NI KRO <name> BaCK DO",
"JUST NOW AYA KRO <name> KAMINA BOTTER Fan <name>",
"Robot <me> hayee sadQe <name>",
"Bot <me> use krta <me> ko ADD KRO",
"<me> OnLine hO K B IGnOre <name> ko like bck, by bot, haha",
"Emang me waari javan <me> ...",
"liked by <me> status nya POST KRO, solnya <name> BOT ON, hehe",
);

$AbdulRehmanNomer=array(
array(
"Agar Cmnt Samaz Na aye2o Inbox Ma Ajao <name>",
"Neerey Aaa AAh Zalima Vee",
"Liat nih robot <me> bisa komen <name>",
"Asik komen no satu dapet pacar baru",
"Wkwkwkwk success koment AB TRI BARI <name>",
"LIKES DOWN <name>",
),
array(
"Agar Cmnt acha Na Laga 2ho Ratko Bedrom Ma Ajana <name>",
"Cmnt Let <name> multi komen Robot <me>",
"<name> like back ni arha, kia hua",
"<name> , unfrnd kro, agr close ni krna to <me> apko deta now pe",
"Do koment <me> ko <name> fast",
"humare liye b dua <name> apki jaan hu",
"faasla rkho <name> warna set hojao ghyy bachii sth :v ",
),
array(
"Ap 2ho Femus Fb me <name>",
"Hore posisi tiga komen di bawahnya <name> asik",
"Komen deh kaya <name> plzz ek dua",
"Haze sbr krO  <name>",
"Slm <name> tukeran posisi komen yuk,",
),
array(
"Yah... Komen <me> Ka hy",
"ho haye gf ka no. to inbOx kr apni  <name>",
"Hadeh... Komen me telat abis neh",
"Sorry i hate unlikers,.....Hehehe",
"Maff <name> Ma Tera Duya chata hon Bas.....",
));

$AbdulRehmanPhoto=array(
"Wah photo nayii alaw <name> Back kro ab fast",
"Me tra Fan Fan Fan HOgya :D  <name> ??",
"<name> Tu Chaaa Gya bache",
"Photo new nih....?  <name>",
"<name> famous h0na hy t0 like...CmT Zaruri Hy",
"Waduh.... DP EDIT KR LETE HO <name> ???",
"<me> online na b ho k now deta",
"Photo dkh jealous ho.... buhahahha",
"Upload KRNE LGA HU <name>,",
"Facebook me kia he ... <name>",
"<me> ka bas, timeline aja, hehe",
"<me> Sif Mutibot Use Krta Hy",
"Janu Apki Dp UmMmmmah...",
"Kapan yah bs upload foto, <name> sexy hy",
"<name> photo edit, kr",
" photoshop KA KAMAAL... SARA",
"zuku ka girl frnd Hot hy .....' Inbox kar <name> Riply Degi",
"Multi Bot  ... by <me>",
"Foto nayi dal <name> ",
"<name> ek Dafa Bot Laglo",
"Ok <name>",
);
...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site='Bot Powered by #Taneel khan';
$true=$ops.'
 '.$ips.'
 '.$site;
